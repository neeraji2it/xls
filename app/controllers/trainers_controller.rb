...
def search
@trainers = Trainer.search(params[:trainer_name],params[:trainer_industry],params[:trainer_expertise],params[:trainer_experience],params[:trainer_geography],params[:rating]).order("created_at DESC")
end
